...
export default function App() {
    ...
    const handleLogin = async (role: 'pharmacy' | 'patient') => {
        ...
        // Test E-postalarını ön tanımla
        let loginEmail = role === 'pharmacy' ? 'admin@ilac.com' : 'hasta@ilac.com';
        let loginPassword = '123456';

        try {
            // API'ye POST isteği gönder
            const response = await apiClient<{ token: string, user: any }>(API_ENDPOINTS.LOGIN, {
                method: 'POST',
    ...
    // Kullanıcı giriş yapmamışsa, rol seçimi ve login ekranını göster
    if (!currentUser) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
                <div className="max-w-4xl w-full">
                    ...
                    <div className="bg-white p-8 rounded-2xl border-2 border-gray-200 shadow-xl">
                        ...
                        {/* Not: Gerçek Uygulamada Manuel Form Kullanılmalı */}
